    ...
    if(mysqli_num_rows($result) > 0){
     ...
     $error[] = 'user already exist!';
        ...
        if($pass != $cpass){
            ...
            $insert = "INSERT INTO provider_form(name, email, phone, city, password) VALUES('$name', '$email', '$phone', '$city', '$pass')";
...
<p> already have an account? <a href="login.php"> update</a></p>
